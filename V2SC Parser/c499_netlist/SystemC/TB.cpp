...
void c499_netlist_TB::testPtr()
{
	while (true)
	{
		...
		testData40.write(SC_LOGIC_0);
		testData41.write(SC_LOGIC_0);
		wait(1000, SC_NS);
...
std::vector<std::string> c499_netlist_TB::read_testPtr(std::string filename)
{
