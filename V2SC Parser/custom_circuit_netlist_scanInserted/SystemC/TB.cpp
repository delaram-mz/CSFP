...
void custom_circuit_netlist_scanInserted_TB::testPtr()
{
	while (true)
	{
		NbarT.write(false);
...
std::vector<std::string> custom_circuit_netlist_scanInserted_TB::read_testPtr(std::string filename)
{
...
void custom_circuit_netlist_scanInserted_TB::endOfSim()
{
	while (true)
{
