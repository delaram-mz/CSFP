...
{
	sc_in <sc_logic> N1, N2, N3, N6, N7;
	sc_out <sc_logic> N22, N23;
	sc_signal <sc_logic> _00_, _01_, _02_, _03_, _04_, _05_, _06_, _07_, _08_, _09_, _10_, _11_, _12_, _13_, _14_;
	...
	SC_CTOR(c17_netlist)
	{
        ...
        sensitive <<N2<<N3<<N1<<N6<<_11_<<N7<<_05_;
	}
	void ini();
	void assignments();
