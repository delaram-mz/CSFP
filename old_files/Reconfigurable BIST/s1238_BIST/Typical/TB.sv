...
parameter sizePI      = 14; 
parameter sizePO      = 14;
parameter PRPG_Size   = 14;
parameter MISR_Size   = 14;
parameter SRSG_Size   = 18;
parameter SISA_Size   = 18;

parameter ShiftSize   = 18;
parameter numOfCycles = 4;
parameter numOfRounds = 5;
parameter groupValue = 47;
parameter bound = groupValue*numOfRounds;
...
initial begin
	...
	faultFile = $fopen("s1238_faultlist.flt", "r");
	...
	$fwrite(logFile, "\n\n==========> # Group Value: %f \n", groupValue);
	$fwrite(logFile, "==========> # of Detected Faults: %f \n", detectedFault);
	$fwrite(logFile, "==========> # of Injected Faults: %f \n", faultCount);
	$fwrite(logFile, "==========> Fault Coverage Typical: %f \n", detectedFault/faultCount);
