module s820_testable 
    ...
    output reg [7:0] sigAddrOut;
    wire [7:0] sigAddr, groupVal, addr_groupVal;
 ...
 // PRPG instance
    ...
    assign PRPG_seed_local = ((groupVal == 8'b00000000) || (flippingVal == 6'b111111)) ? PRPG_seed : flipped_seed;
    assign addr_groupVal = (groupVal == 8'b00000000)? 8'b10000000 : groupVal -1;
