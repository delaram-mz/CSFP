...
parameter sizePI      = 18; 
parameter sizePO      = 19;
parameter PRPG_Size   = 18;
parameter MISR_Size   = 19;
parameter SRSG_Size   = 5;
parameter SISA_Size   = 5;

parameter ShiftSize   = 5;
parameter numOfCycles = 4;
parameter numOfRounds = 3;
parameter groupValue = 60;
...
initial begin
	...
	faultFile = $fopen("s820_faultlist.flt", "r");
