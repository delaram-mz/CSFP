module s344_testable 
    ...
    wire [3:0] sigAddr, groupVal, addr_groupVal;
    ...
    assign PRPG_seed_local = (groupVal == 4'b0000) ? PRPG_seed : flipped_seed;
    assign addr_groupVal = (groupVal == 4'b0000)? 4'b1010 : groupVal -1;
