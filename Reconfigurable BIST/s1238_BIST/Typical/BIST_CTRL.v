...
module BIST_CTRL 
	...
	wire [5:0] SC_cnt_out , TC_cnt_out, TR_cnt_out, group_cnt_out;
	...
	counter #( .n(6) ) TestCycle_Cnt_inst (
            .clk(clk), 
            .rst(TC_cnt_rst), 
            .en(TC_cnt_en),
            .out(TC_cnt_out)
	...
	counter #( .n(6) ) TestRound_Cnt_inst (
            .clk(clk), 
            .rst(TR_cnt_rst), 
            .en(TR_cnt_en),
            .out(TR_cnt_out)
