...
void s1238_netlist_scanInserted_TB::testPtr()
{
	while (true)
	{
		NbarT.write(false);
...
std::vector<std::string> s1238_netlist_scanInserted_TB::read_testPtr(std::string filename)
{
...
void s1238_netlist_scanInserted_TB::endOfSim()
{
	while (true)
{
